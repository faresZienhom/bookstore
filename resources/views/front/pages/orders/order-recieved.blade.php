      ...
      <section class="section-container profile my-5 py-5">
        <div class="text-center mb-5">
          <div class="success-gif m-auto">
            <img class="w-100" src="{{url('front/assets/images/success.gif')}}" alt="" />
          </div>
        ...
        <table class="success__table w-100 mb-5">
          ...
          <tbody>
            <tr>
              <td>
                <div>
                  <a href="{{route('single.product.index')}}">كوتش فلات ديزارت -رجالى - الابيض, 42</a> x 1
                </div>
                <div>
            ...
            <tr>
              <td>
                <div><a href="{{route('single.product.index')}}">كوتش كاجوال -رجالى - بنى, 43</a> x 1</div>
                <div>
                  <span class="fw-bold">اللون:</span>
                  <span>بني</span>
                </div>
