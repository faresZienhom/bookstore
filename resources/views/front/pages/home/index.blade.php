          ...
          <div class="owl-carousel hero__carousel owl-theme">
            ...
            @isset($sliders)
                ...
                <div class="hero__item">
                    <img class="hero__img" src="{{ asset ( "images/slider/" .$slider->image) }}" alt="">
                </div>
                @empty
                <div class="hero__item">
            ...
            @isset($products)
                ...
                <div class="products__item">
                    <div class="product__header mb-3">
                      <a href="{{route('single.product.index', $product->id)}}">
                        <div class="product__img-cont">
                          <img class="product__img w-100 h-100 object-fit-cover" src="{{ asset ( "images/products/" .$product->image) }}" data-id="white">
                        </div>
                      </a>
                    ...
                    <div class="product__title text-center">
                      <a class="text-black text-decoration-none" href="{{route('single.product.index', $product->id)}}">
                        {{ $product->title }}
                      </a>
                    </div>
            ...
            @isset($banners)
                ...
                <div class="col-md-6 p-2">
                    <div class="p-4 border rounded-3">
                        <img class="w-100" src="{{asset($banner->image)}}"alt="">
                    </div>
                </div>
                @endforeach
            @endisset
